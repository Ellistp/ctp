                ...
                <div class="box span4" ontablet="span6" ondesktop="span4">
                    ...
                    <div class="box-content">
                        <ul class="dashboard-list">
                            <li>
                                <a href="#">
                                    <img class="avatar" alt="Lucas" src="${ctx}/img/avatar.jpg"/>
                                </a>
                            ...
                            <li>
                                <a href="#">
                                    <img class="avatar" alt="Bill" src="${ctx}/img/avatar9.jpg"/>
                                </a>
                            ...
                            <li>
                                <a href="#">
                                    <img class="avatar" alt="Jane" src="${ctx}/img/avatar5.jpg"/>
                                </a>
                            ...
                            <li>
                                <a href="#">
                                    <img class="avatar" alt="Kate" src="${ctx}/img/avatar6.jpg"/>
                                </a>
