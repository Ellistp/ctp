                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="field_notice">Price Range: <span class="must sliderRangeLabel">$192 - $470</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="field_notice">Value: <span class="must progressAnimateValue">0%</span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="field_notice">Uploading: <span class="must progressUploadAnimateValue">0 Mb</span>
                                        / 4096 Gb
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="box span12">
                    ...
                    <div class="box-content buttons">
                        ...
                        <div class="btn-group">
                            ...
                            <button class="btn btn-large dropdown-toggle btn-primary" data-toggle="dropdown"><span
                        ...
                        <div class="btn-group">
                            ...
                            <button class="btn btn-large dropdown-toggle btn-danger" data-toggle="dropdown"><span
                                    class="caret"></span></button>
                            <ul class="dropdown-menu">
                                <li><a href="#"><i class="icon-star"></i> Action</a></li>
                                <li><a href="#"><i class="icon-tag"></i> Another action</a></li>
                        ...
                        <div class="btn-group">
                            ...
                            <button class="btn btn-large dropdown-toggle btn-warning" data-toggle="dropdown"><span
                                    class="caret"></span></button>
                            <ul class="dropdown-menu">
                                <li><a href="#"><i class="icon-star"></i> Action</a></li>
                                <li><a href="#"><i class="icon-tag"></i> Another action</a></li>
                        ...
                        <div class="btn-group">
                            ...
                            <button class="btn btn-large dropdown-toggle btn-success" data-toggle="dropdown"><span
                                    class="caret"></span></button>
                            <ul class="dropdown-menu">
                                <li><a href="#"><i class="icon-star"></i> Action</a></li>
                                <li><a href="#"><i class="icon-tag"></i> Another action</a></li>
                ...
                <div class="box span12">
                    ...
                    <div class="box-content">
                        ...
                        <p class="center">
                            ...
                            <button class="btn btn-primary" id="add-without-image"><i class="icon-bell"></i>w/o image
                            </button>
                            <button class="btn btn-primary" id="add-gritter-light"><i class="icon-bell"></i>White
                            </button>
                    ...
                    <div class="box-content">
                        ...
                        <p class="center">
                            ...
                            <button class="btn btn-primary noty"
                                ...
                                <i class="icon-bell"></i> Bottom Right (fade)
                            </button>

                            <button class="btn btn-primary noty"
                                    data-noty-options='{"text":"This is an alert","layout":"bottom","type":"alert","closeButton":"true"}'>
                                <i class="icon-bell"></i> Bottom Full Width with Close Button
                            </button>
                        </p>
                    </div>
                    ...
                    <div class="box-content">
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-danger" data-rel="popover"
                                       ...
                                       title="A Title">Hover for popover</a>
                                </td>
                            </tr>
                            <tr>
                                <td>Dialog</td>
                            ...
                            <tr>
                                <td>Tooltip</td>
                                <td>
                                    <a href="#" title="Tooltip, you can change the position." data-rel="tooltip"
