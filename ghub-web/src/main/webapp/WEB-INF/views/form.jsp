            ...
            <div class="row-fluid">
                ...
                <div class="box span12">
                    <div class="box-header">
                        <h2><i class="icon-edit"></i>Wizard</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <div id="MyWizard" class="wizard">
                            ...
                            <div class="actions">
                                ...
                                <button type="button" class="btn btn-success btn-next" data-last="Finish">Next <i
                        ...
                        <div class="step-content">
                            ...
                            <div class="step-pane" id="step3">
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select data-placeholder="Your Favorite Football Team" id="selectError20"
                                                    data-rel="chosen">
                                                <option value=""/>
                            ...
                            <div class="step-pane" id="step4">
                                ...
                                <p>
                                    ...
                                    eorum claritatem. Investigationes demonstraverunt lectores legere me lius quod ii
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="input-prepend input-append">
                                        <span class="add-on">$</span><input id="appendedPrependedInput" size="16"
