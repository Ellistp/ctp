...
<div class="content">
    <form class="login-form" action="/api/ghub/login" method="post">
...
<script src="assets/plugins/jquery-validation/jquery-validation-dist/jquery.validate.min.js" type="text/javascript"></script>
